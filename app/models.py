...
class Mailbox(db.Model):
    ...
    # New status flags
    added_to_server = db.Column(db.Boolean, default=False, nullable=False)  # Track if added to the server
    added_to_smartlead = db.Column(db.Boolean, default=False, nullable=False)  # Track if added to SmartLead
